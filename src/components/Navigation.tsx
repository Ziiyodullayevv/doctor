...
export default function Navigation() {
  return (
    <div className='container flex  justify-between items-center gap-10 px-10 py-3'>
      <div className='flex gap-10 items-center'>
        <div>
          <span className='text-primary font-bold'>MUHAMMAD</span>
          <span className='text-blue-500 font-bold'>RIZO</span>
        </div>
      ...
      <div className='flex items-center gap-6'>
        <div className='flex items-center hover-group gap-2'>
          <Smartphone className='size-4.5' />
          <a className='font-medium text-sm' href='tel:+998995476202'>
            +998 (99) 547-62-02
          </a>
        </div>
        <ModeToggle />

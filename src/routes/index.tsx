...
import GenitalPage from "@/features/operations/pages/GenitalPage";
import PlasticPage from "@/features/operations/pages/PlasticPage";
import UrologyPage from "@/features/operations/pages/UrologyPage";
...
export const routes = createBrowserRouter([
	{
		...
		children: [
			...
			{ path: "/operations/genital", element: <GenitalPage /> },
			{ path: "/operations/urology", element: <UrologyPage /> },
			{ path: "/operations/plastic", element: <PlasticPage /> },
		],
	},
]);
